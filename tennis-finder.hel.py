...
def fetch_raw_data(baseurl: str, the_date: str, book_path: str = '/booking/booking-calendar'):
    """Fetches web-page
...
if __name__ == '__main__':
    print('This program finds tennis centers availability for the upcoming days in Helsinki.\n')
    tennis_finder_hel()
